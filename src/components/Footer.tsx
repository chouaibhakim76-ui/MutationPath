          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <motion.a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-mono text-[10px] text-text-secondary hover:text-white transition-colors duration-200"
                style={{
            ...
            <div className="flex flex-wrap gap-2">
              {TECH_STACK.map((tech) => (
                <motion.span
                  ...
                  className="font-mono text-[10px] px-2.5 py-1 rounded-lg tracking-wide cursor-default"
                  style={{
                    background: `${tech.color}12`,
                    border: `1px solid ${tech.color}28`,
                    color: tech.color,
                    boxShadow: `0 0 8px ${tech.color}10`,
                  }}
                >
                  {tech.label}
                </motion.span>
