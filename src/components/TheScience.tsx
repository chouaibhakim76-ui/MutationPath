            ...
            {[
              {
                ...
                body: 'Each viral generation produces offspring with random mutations. Survival probability depends on fitness — mirroring real evolutionary dynamics used in epidemiological modeling.',
              },
              {
                color: '#39ff14',
                ...
                body: 'Three fitness axes — transmissibility, immune evasion, virulence — create a multidimensional landscape. Mutations navigate this landscape, and only the fittest strains persist.',
              },
              {
                color: '#ff1744',
              ...
              },
              {
                ...
                body: 'The algorithm produces phylogenetic patterns consistent with real viral evolution — bushy trees for fast-mutating viruses like HIV, ladder-like trees for conserved viruses like Measles.',
              },
            ].map((card) => (
              <div
                key={card.title}
        ...
        >
          ...
          >
            ...
            <svg viewBox="0 0 400 480" className="w-full h-auto p-2">
              ...
              <text x="50" y="455" fill="#e0e0ec" fontSize="9" fontFamily="Inter" opacity="0.2">Branch ∝ mutation distance</text>
            </svg>
          </div>
        </motion.div>
      </div>
